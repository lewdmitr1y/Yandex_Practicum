...
|8. ДЗ_11|Разработка тест-плана и проведение тестирования. Составление ПМИ, проведение тестирования, создание руководства пользователя|Google Docs|
|9. Проект №1. Спецификация требований ко второму релизу Chatty|Описание сценариев использования в табличной форме и в виде диаграммы, функциональных требований, атрибутов качества, бизнес-правил, глоссария.|Google Docs, draw.io|
|10. Проект №2. Моделирование данных и работа с базой данных интернет-магазина «Накарабине»|Создание логической модели данных и приведение её к 3НФ, описание словаря данных, уточнение требований и вариантов использования.|Google Docs, draw.io|
|11. Проект №3. Бэклог приложения для сети клиник «Вита»|Составление DFD-диаграммы в нотации Гейна-Сарсон, интерактивных hi-fi прототипов интерфейса и карты пользовательских историй с сценариями приёмки.|Miro, draw.io, Figma|
...
|13. API|Реализация API для новой фичи в приложении.|Google Docs, Postman, draw.io, Swagger|
